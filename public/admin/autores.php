...
<div class="container">
    <div class="page-header animate-fadeIn">
        <div>
            <h1>✒️ Gestionar Autores</h1>
            <p>Administra los autores literarios del catálogo</p>
        </div>
                    ...
                    <tbody>
                        <?php foreach ($authors as $author): ?>
                            <tr>
                                ...
                                <td><strong><?= htmlspecialchars($author['nombre']) ?></strong></td>
                                ...
                                <td>
                                    <div class="action-buttons">
                                        ...
                                        <button class="btn-icon btn-icon-danger" onclick="deleteEntity(<?= $author['id_autor'] ?>, 'author')"
                                            title="Eliminar">
                                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
